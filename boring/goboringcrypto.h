...
/*unchecked (opaque)*/ typedef struct GO_EVP_MD {
    char data[1];
} GO_EVP_MD;
...
/*unchecked (opaque)*/ typedef struct GO_EVP_AEAD {
    char data[1];
} GO_EVP_AEAD;
/*unchecked (opaque)*/ typedef struct GO_ENGINE {
    char data[1];
} GO_ENGINE;
...
typedef struct GO_EVP_AEAD_CTX {
    char data[600];
} GO_EVP_AEAD_CTX;
...
/*unchecked (opaque)*/ typedef struct GO_BN_CTX {
    char data[1];
} GO_BN_CTX;
typedef struct GO_BIGNUM {
    char data[24];
} GO_BIGNUM;
...
/*unchecked (opaque)*/ typedef struct GO_EC_KEY {
    char data[1];
} GO_EC_KEY;
...
typedef struct GO_RSA {
    void *meth;
    GO_BIGNUM *n, *e, *d, *p, *q, *dmp1, *dmq1, *iqmp;
    char data[168];
} GO_RSA;
/*unchecked (opaque)*/ typedef struct GO_BN_GENCB {
    char data[1];
} GO_BN_GENCB;
...
/*unchecked (opaque)*/ typedef struct GO_EVP_PKEY {
    char data[1];
} GO_EVP_PKEY;
...
/*unchecked (opaque)*/ typedef struct GO_EVP_PKEY_CTX {
    char data[1];
} GO_EVP_PKEY_CTX;
