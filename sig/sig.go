...
//
// 	copy(priv.key[:32], privBytes[32:])
// 	copy(priv.key[32:], A.Bytes())
//
// 	return priv
// }
//
...
// 	// 	panic("ed25519: internal error: setting scalar failed")
// 	// }
// 	copy(privateKey.prefix[:], h[32:])
// 	// fmt.Println(privateKey.prefix)
//
// 	A := (&edwards25519.Point{}).ScalarBaseMult(s)
//
// 	copy(privateKey.key[:32], seed[:])
// 	copy(privateKey.key[32:], A.Bytes())
//
...
// 	//
// 	//    memcopy_avx2_32(unsafe.Pointer(&s0[:32]), unsafe.Pointer(&Rbytes[0]))
// 	//
